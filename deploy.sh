...
gcloud run deploy $SERVICE_NAME \
  ...
  --timeout 3600 \
  --concurrency 1 \
  --set-env-vars "GOOGLE_CLOUD_PROJECT=$PROJECT_ID,DD_OPS_MODELS_BUCKET=dd_ops_models,PYTHONDONTWRITEBYTECODE=1,PYTHONUNBUFFERED=1,GCP_PROJECT_ID=$PROJECT_ID,GCP_LOCATION=us-central1,DOCUMENT_AI_PROJECT_ID=75499681521,DOCUMENT_AI_PROCESSOR_ID=599b6ebb19fa1478,DOCUMENT_AI_LOCATION=us"
